		...
		<view class="container">
			<scroll-view scroll-y="true" >
					<view class="search-search" >
						...
						<text v-show="searchType != 1 " class="iconfont icon-close-bold" @tap="handleToClose"></text>
					</view>
...
<script>
	...
	import { searchHot , searchWord , searchSuggest } from '../../common/js/api.js'
	export default {
		data() {
			return {
				searchHot:[],
